...
export const ContainerScrollAnimation = ({
  ...
  return (
    <div
      className="h-[28rem] md:h-[40rem] flex items-center justify-center relative p-2 md:px-20 overflow-hidden"
      ref={containerRef}
    >
      <div
...
export const Card = ({
  ...
  return (
    <motion.div
      ...
      className="max-w-2xl -mt-4 mx-auto h-[16rem] md:h-[24rem] w-full border border-white/10 p-2 md:p-3 bg-stone-950 rounded-[1.5rem] shadow-2xl relative z-10"
    >
